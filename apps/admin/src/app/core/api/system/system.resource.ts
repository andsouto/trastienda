 ...
 */
export function getLivezResource(options: OrvalHttpResourceOptions<GetLivez200, unknown> & { defaultValue: NoInfer<GetLivez200> }): HttpResourceRef<GetLivez200>;
export function getLivezResource(options?: OrvalHttpResourceOptions<GetLivez200, unknown>): HttpResourceRef<GetLivez200 | undefined>;
export function getLivezResource(options?: OrvalHttpResourceOptions<GetLivez200, unknown>): HttpResourceRef<GetLivez200 | undefined> {
  return httpResource<GetLivez200>(() => applyOrvalRequestExtension(`/livez`, options), options);
}

/**
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getReadyzResource(options: OrvalHttpResourceOptions<GetReadyz200, unknown> & { defaultValue: NoInfer<GetReadyz200> }): HttpResourceRef<GetReadyz200>;
export function getReadyzResource(options?: OrvalHttpResourceOptions<GetReadyz200, unknown>): HttpResourceRef<GetReadyz200 | undefined>;
export function getReadyzResource(options?: OrvalHttpResourceOptions<GetReadyz200, unknown>): HttpResourceRef<GetReadyz200 | undefined> {
  return httpResource<GetReadyz200>(() => applyOrvalRequestExtension(`/readyz`, options), options);
}

/**
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getMeResource(options: OrvalHttpResourceOptions<GetMe200, unknown> & { defaultValue: NoInfer<GetMe200> }): HttpResourceRef<GetMe200>;
export function getMeResource(options?: OrvalHttpResourceOptions<GetMe200, unknown>): HttpResourceRef<GetMe200 | undefined>;
export function getMeResource(options?: OrvalHttpResourceOptions<GetMe200, unknown>): HttpResourceRef<GetMe200 | undefined> {
  return httpResource<GetMe200>(() => applyOrvalRequestExtension(`/me`, options), options);
}

export type GetLivezResourceResult = NonNullable<GetLivez200>
export type GetReadyzResourceResult = NonNullable<GetReadyz200>
export type GetMeResourceResult = NonNullable<GetMe200>
